...
// Allow override at build time with REACT_APP_API_BASE_URL.
// If unset, default to relative "/api" so requests go through the same origin proxy.
const API_URL = process.env.REACT_APP_API_BASE_URL !== undefined && process.env.REACT_APP_API_BASE_URL !== ''
